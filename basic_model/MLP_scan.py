...
class CNN_SimpleScanningMLP():
    ...
    def init_weights(self, weights):
        # Load the weights for your CN:N from the MLP Weights given
...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        self.conv1.W = np.transpose(w1[:24*2, :2].T.reshape((2, 2, 24)), (0, 2, 1))
        self.conv2.W = np.transpose(w2[:2*2, :8].T.reshape((8, 2, 2)), (0, 2, 1))
        self.conv3.W = np.transpose(w3[:8*2, :4].T.reshape((4, 2, 8)), (0, 2, 1))
